...
contract Arbitrage {
  ...
  //borrow 100 dai from flashlan
  // reimbuse for collateral
  // collatelal - borrowd amount > flashloan abount
  ...
  function pancakeCall(
    ...
    // Caulate the amount we want to reimbure to the flashloan in uniswap
    ...
    // sell the token (->amountToken) we borrow from Uniswap to bakery
